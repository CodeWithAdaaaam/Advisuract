  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="pt-40 pb-10 px-6 max-w-3xl mx-auto">
        <p className="text-violet-400 text-sm font-semibold uppercase tracking-widest mb-4">{content.category}</p>
      ...
      {article.cover && (
        <div className="max-w-3xl mx-auto px-6 mb-10">
          <Image src={article.cover} alt={content.title} width={800} height={400} className="w-full rounded-xl object-cover max-h-96" unoptimized />
        </div>
      )}
